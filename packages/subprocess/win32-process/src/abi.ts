...
/** STARTUPINFOW carries a show-window request in wShowWindow. */
export const STARTF_USESHOWWINDOW = 0x00000001
/** wShowWindow value that keeps a newly allocated console window off screen. */
...
/** CreateProcess flag that keeps a console-subsystem child windowless. */
