 ...
 *
 * A text-only model (DeepSeek V4 Pro) cannot accept image input. When
...
import type { ContentBlock, ContextFormed, FinishReason, GenerateOptions, LlmRuntime, Message } from '@deepseek-ai/dsh-llm'
...
declare module '@deepseek-ai/dsh-llm' {
  interface MessageSourceMap {
    /** The describe request this service sends to the vision model; it is
     * never logged, and readers preserve the content without this producer.
     * @persistenceAttribution
     */
    'vision-routing': { kind: 'vision-routing' } & ContextFormed
  }
}
