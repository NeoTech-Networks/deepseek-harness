...
| [`pinned-files/`](pinned-files/README.md) | Owns the operator's pinned directories in the settings document, and lists and reads inside them without a workspace fence. | `ctx.pinnedFiles` / `ctx.remote.pinnedFiles` |
