...
describe('product icon set', () => {
  it('exports regular and medium variants for all 101 public glyphs', () => {
    // 93 upstream glyphs plus the fork's eight session stage marks.
    expect(iconNames.length).toBe(202)
