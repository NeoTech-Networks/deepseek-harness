...
export const zh = {
  ...
  'bulk.description': '把选中的每个子文件夹注册成各自的工作区，并在第一个里打开会话。',
  'bulk.group': '分组标签',
...
export const en = {
  ...
  'bulk.description': 'Register each selected sub-folder as its own workspace, and open a session in the first one.',
