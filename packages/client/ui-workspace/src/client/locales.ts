...
export const zh = {
  ...
  'group.title': '设置分组',
  'group.save': '保存',
  'group.toggle': '展开或收起“{name}”分组',
  'field.groupName': '分组名称',
  'toast.nothingToArchive': '暂无可归档的会话',
  'toast.archiveFailed': '会话归档失败',
  'section.allSessions': '全部会话',
  'allSessions.toggle': '展开或收起全部会话',
  'error.sectionCrashed': '本栏未能绘制。',
  'error.sectionRetry': '重试',
  'menu.setStatus': '设置状态…',
...
export const en = {
  ...
  'group.set': 'Set group…',
  'group.title': 'Set group',
  'group.save': 'Save',
  'group.toggle': 'Expand or collapse the {name} group',
  'field.groupName': 'Group name',
  'toast.nothingToArchive': 'Nothing to archive yet',
  'toast.archiveFailed': 'The session could not be archived',
  'section.allSessions': 'All Sessions',
  'allSessions.toggle': 'Toggle All Sessions',
  'error.sectionCrashed': 'This section could not be drawn.',
  'error.sectionRetry': 'Retry',
  'menu.setStatus': 'Set status…',
  'menu.clearStatus': 'Clear status',
  'status.title': 'Set status',
  'status.clear': 'Clear status',
  'status.loading': 'Loading statuses…',
