...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/session-status/session-status': { kind: 'none', reason: 'The status service registers no tool or prompt; the sibling tool-session-status package owns the model-facing set_session_status schema.' },
