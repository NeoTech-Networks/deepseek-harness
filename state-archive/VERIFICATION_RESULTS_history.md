# VERIFICATION_RESULTS - archived history

Auto-archived by state_file_cap.py when VERIFICATION_RESULTS.md exceeded 32 KB. Newest-first. On-demand only; not read at session start.
